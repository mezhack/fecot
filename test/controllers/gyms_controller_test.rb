...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference("Gym.count") do
      post gyms_url, params: { gym: { address: @gym.address, latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name, responsible_id: @gym.responsible_id } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { address: @gym.address, latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name, responsible_id: @gym.responsible_id } }
